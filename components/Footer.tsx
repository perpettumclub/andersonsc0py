                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-t border-white/5 pt-16">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex items-center gap-3 mt-8">
                            <Instagram className="w-4 h-4 text-wope-primary" />
                            <a href="https://www.instagram.com/anderson.copy" target="_blank" rel="noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">@anderson.copy</a>
                        </div>
                    </div>
                </div>
